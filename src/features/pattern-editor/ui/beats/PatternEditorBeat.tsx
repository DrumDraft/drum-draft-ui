...
const beatStyles = tv({
  base: "rounded-lg border-2 rotate-45 -translate-x-1/2 -translate-y-1/2 shadow-[0_0_16px_rgba(0,0,0,0.1)]",
  variants: {
    type: {
      regular: "bg-white border-content4",
      ghost:
        "bg-default-300/60 border-content1 shadow-[0_0_16px_rgba(0,0,0,0.1)]",
    },
  },
  defaultVariants: {
    type: "regular",
